...
const BOT_TOKEN = 'Sizning_Telegram_Bot_Tokeningiz'; // Bot tokeningizni shu yerga yozing
...
app.post('/api/attendance', (req, res) => {
    ...
    if (student.parentChatId) {
        ...
        if (student.balance <= -150000) {
            bot.sendMessage(student.parentChatId, `⚠️ DIQQAT! Farzandingiz ${student.name}ning qarzi ${Math.abs(student.balance)} so'mga yetdi. Iltimos, to'lov qiling!`);
        }
    }
...
// Har oyning 1-kunida tarixga olish
...
// RENDER.COM UCHUN DINAMIK PORT SOZLAMASI
const PORT = process.env.PORT || 10000;
app.listen(PORT, '0.0.0.0', () => console.log(`Server Renderda ${PORT}-portda yondi!`));
